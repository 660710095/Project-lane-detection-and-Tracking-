...
SRC_TOP_LEFT_X = 0.44       # ปรับจุดยอดให้สมดุลกับระยะสายตาบนถนนไทย
SRC_TOP_RIGHT_X = 0.56      
SRC_BOTTOM_RIGHT_X = 0.90   
SRC_TOP_Y = 0.65            # ขยับขอบบนลงมาเล็กน้อยเพื่อหนี Noise จากรถคันหน้าหรือขอบฟ้า
